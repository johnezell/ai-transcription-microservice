always use docker container aws-transcription-laravel when running npm, npx, php and related commands
when creating testing or debug files prefix with ai_roo_ for each filename
