...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | When your application is behind a proxy (like ngrok), you may want to
    | force all URL generation to use HTTPS scheme. This is useful when
    | serving the app through HTTPS tunnels.
    |
    */
