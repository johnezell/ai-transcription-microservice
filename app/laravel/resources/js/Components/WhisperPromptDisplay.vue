    ...
    <div class="whisper-prompt-display">
        ...
        <div v-if="isLoading" class="bg-gray-50 border border-gray-200 rounded-lg p-4">
            <div class="flex items-center space-x-3">
                ...
                <span class="text-sm text-gray-600">Loading WhisperX configuration...</span>
            </div>
        </div>
            ...
            <div class="flex items-start space-x-3">
                ...
                <div class="flex-1">
                    ...
                    <h4 class="text-sm font-medium text-blue-900 mb-3">
                        WhisperX Configuration - {{ presetConfig.name }} Preset
                    </h4>
        ...
        <div v-else class="bg-gray-50 border border-gray-200 rounded-lg p-4">
            <div class="flex items-center space-x-3">
                ...
                <span class="text-sm text-gray-600">No WhisperX configuration available for this preset</span>
            </div>
        </div>
    </div>
</template>
