              ...
              <div v-for="category in categories" :key="category.id" class="border border-gray-200 rounded-lg overflow-hidden">
                <div class="flex items-center justify-between p-4" :class="getCategoryHeaderClass(category.color_class)">
                  ...
                  <div class="flex items-center space-x-2">
                    ...
                    <Link :href="route('admin.music-terms.categories.edit', category.id)" class="text-gray-600 hover:text-gray-900 p-1">
...
const deleteCategory = () => {
  if (categoryToDelete.value) {
    router.delete(route('admin.music-terms.categories.destroy', categoryToDelete.value.id), {
      onSuccess: () => {
...
const deleteTerm = () => {
  if (termToDelete.value) {
    router.delete(route('admin.music-terms.terms.destroy', termToDelete.value.id), {
      onSuccess: () => {
