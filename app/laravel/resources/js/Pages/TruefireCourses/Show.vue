                                    ...
                                    <tr v-for="segment in filteredSegments" :key="segment.id" class="hover:bg-gray-50">
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <div class="flex space-x-2">
                                                <!-- Review Link (Primary Action) -->
                                                <Link
                                                    :href="route('truefire-courses.segments.review', [props.course.id, segment.id])"
                                                    class="inline-flex items-center px-3 py-1 bg-green-600 text-white rounded-md text-xs hover:bg-green-700 transition-all duration-200"
                                                >
                                                ...
                                                <!-- Technical Details Link (Secondary Action) -->
                                                <Link
                                                    :href="route('truefire-courses.segments.show', [props.course.id, segment.id])"
                                                    class="inline-flex items-center px-3 py-1 bg-gray-500 text-white rounded-md text-xs hover:bg-gray-600 transition-all duration-200"
                                                >
                                                    <svg class="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
