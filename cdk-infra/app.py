...
# db_secret_arn = "arn:aws:secretsmanager:us-east-1:542876199144:secret:prod/thoth/db-3FuVTh" # Moved into CdkInfraStack
# database_secret = secretsmanager.Secret.from_secret_complete_arn(app, "ImportedDBSecret", db_secret_arn) # Moved into CdkInfraStack
...
laravel_service_stack = LaravelServiceStack(app, "LaravelServiceStack",
    ...
    db_secret=main_infra_stack.database_secret,
